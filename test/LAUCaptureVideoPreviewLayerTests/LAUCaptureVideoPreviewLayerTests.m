...
- (void)setUp {
    ...
    mockLAUCaptureVideoPreviewLayerInternal.sampleBufferImage = [UIImage imageNamed:@"source-image.png" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
